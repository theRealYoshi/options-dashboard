module.exports = (function() {
    ...
    */
    ...
    Polo.prototype.convertOpenOrderToDollar = function(currencyPair, openOrderObj) {
        var dollarValue = Poloniex.getCurrencyPairDollarValue(currencyPair);
        var btcDollarValue = Poloniex.getBtcDollarValue();

        return { "rate" : (openOrderObj["rate"] * btcDollarValue).toFixed(2),
                 "startingAmount" : (openOrderObj["startingAmount"] * dollarValue).toFixed(2),
                 "amount" : (openOrderObj["amount"] * dollarValue).toFixed(2),
                 "total" : (openOrderObj["total"] * btcDollarValue).toFixed(2) };
    }
