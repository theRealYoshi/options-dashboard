module.exports = (function() {
    ...
    /*
    */
    Polo.prototype.convertToDollar = function(currencyPair, currencyObj) {
        ...
        Object.keys(currencyObj).forEach(function(key) {
            switch(key) {
                case 'amount':
                case 'startingAmount':
                    dollarObj[key] = (currencyObj[key] * dollarValue).toFixed(2);
                    break;
                case 'total':
                case 'basePrice':
                ...
                case 'rate':
                case 'total':
                    dollarObj[key] = (currencyObj[key] * btcDollarValue).toFixed(2);
                    break;
                default:
                    dollarObj[key] = currencyObj[key];
                    break;
            }
        });
        return dollarObj;
